...
import pandas as pd
import sqlite3
from picture_analysis import get_cam_status ,min2 ,get_west_direction ,seeing

def get_pic_info(pic_path, camera_contents):
    cam_status = get_cam_status(pic_path.replace(pic_path.split(".")[-1], "txt"), contents=camera_contents)
...
if __name__ == "__main__":
    ...
    for pictfolder in pictfolders:
        ...
        for pic_path in pic_pathes:
            ...
            pic_info = get_pic_info(pic_path, setting["camera_columns"].split(","))
